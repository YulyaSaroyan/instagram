...
export const fetchingChat = createAsyncThunk(
    'chat/fetchingChat',
    async function () {
        const usersResponse = await axios.get('https://jsonplaceholder.typicode.com/posts?_limit=10')
        const imagesResponse = await axios.get('https://jsonplaceholder.typicode.com/photos?_limit=10')
